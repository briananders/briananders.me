...
xml.urlset "xmlns" => "http://www.sitemaps.org/schemas/sitemap/0.9" do
  ...
  sitemap.resources.each do |page|
      ...
      throw :next_page if page.url.start_with?('/styles-')
      ...
      throw :next_page if page.url.start_with?('/favicon_base-')
      ...
      xml.url do
        xml.loc 'http://briananders.net' + page.url   # TODO: possibly remove .html
